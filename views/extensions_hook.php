...
$js = '<script type="text/javascript" id="customcontext_js">$("#devinfo_context").parents(".element-container").remove();$("#customcontext").attr("name","devinfo_context");$("#customcontext_js").parents(".element-container").remove();</script>';
